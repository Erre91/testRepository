...
public class People_to_group extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getActionBar().setTitle("Group: " + my_group.getName());
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.people_to_group, menu);
		MenuItem register = menu.findItem(R.id.addPeople);
		if (!my_group.getCreated()) {
	...
	private class MyListAdapter_user extends ArrayAdapter<User> implements
		...
		public MyListAdapter_user() {
			super(ctx, R.layout.item_people_prova);
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (itemView == null) {
				itemView = inflater.inflate(R.layout.item_people_prova, parent,
						false);
			}
			...
			TextView tipo = (TextView) itemView
					.findViewById(R.id.item_peopleGroup_t);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.addPeople:
			Intent intent = new Intent(this, Group_add_people.class);
			intent.putExtra("singleGroup", my_group);
